...
> ⚠️ **Risk Warning**: This bot can lead to loss of your funds. Use at your own risk.

An open-source automated trading bot for executing crypto trading strategies on the Solana blockchain. This is a forked and updated version maintained by **vibecoding**.

## What It Does

This CLI tool automates crypto trading on Solana by leveraging the [Jupiter Aggregator](https://jup.ag/) to find optimal swap routes and execute trades programmatically.

## Tech Stack

- **Node.js** - JavaScript runtime
- **Jupiter SDK** - Solana DEX aggregation and routing
...
- Multiple trading strategies (Arbitrage, PingPong)
- Configurable slippage management
- Interactive setup wizard
- Trade history and statistics
- CLI-based monitoring and charts

## Getting Started

```bash
npm install
npm run wizard    # Start the configuration wizard
npm run trade     # Run the bot
```

## More Information

For detailed documentation, visit the original [ARB Protocol repository](https://github.com/ARBProtocol/solana-jupiter-bot).
