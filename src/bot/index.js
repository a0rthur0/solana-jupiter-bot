	...
	try {
		...
		if (
			...
			if (cache.tradingEnabled || cache.hotkeys.e || cache.hotkeys.r) {
				...
				// Profit will be calculated correctly in successSwapHandler
        // Don't calculate it here as currentBalance is not yet updated
	...
	try {
		...
		if (
			...
			if (cache.tradingEnabled || cache.hotkeys.r) {
				...
				// Profit will be calculated correctly in successSwapHandler
        // Don't calculate it here as balance comparison should be done properly
